...
import { 
  ...
  FaWhatsapp, FaLinkedin, FaTwitter, FaInstagram, FaUser, FaPen,
...
<section id="contact-form" className="relative py-32 bg-[var(--current-bg)] overflow-hidden">
    ...
    >
      ...
      >
        ...
        <div className="relative bg-[var(--current-nav)] p-10 rounded-3xl shadow-2xl border border-white/10">
          ...
          <AnimatePresence>
            {submitStatus && (
              <motion.div
                ...
                exit={{ opacity: 0 }}
                className={`p-4 mb-6 rounded-xl ${submitStatus.type === 'success' ? 
          ...
          <form ref={formRef} onSubmit={handleSubmit} className="space-y-7">
            ...
            >
              <label htmlFor="name" className="block mb-3 font-medium text-white/90">Full Name*</label>
              <div className="relative">
                <input
                  ...
                  className={`w-full p-5 rounded-xl bg-[var(--current-bg)] border ${errors.name ? 'border-red-500/80' : 'border-white/10'} focus:ring-2 focus:ring-primary/50 focus:border-transparent transition-all duration-300 placeholder-white/30`}
                  placeholder="Your name"
                  required
                />
                <FaUser className="absolute right-5 top-1/2 -translate-y-1/2 text-white/30" />
              </div>
            ...
            >
              <label htmlFor="email" className="block mb-3 font-medium text-white/90">Email*</label>
              <div className="relative">
                <input
                  type="email"
                  id="email"
                  ...
                  onChange={handleChange}
                  className={`w-full p-5 rounded-xl bg-[var(--current-bg)] border ${errors.email ? 'border-red-500/80' : 'border-white/10'} focus:ring-2 focus:ring-primary/50 focus:border-transparent transition-all duration-300 placeholder-white/30`}
                  placeholder="your@email.com"
                  required
                />
                <FaEnvelope className="absolute right-5 top-1/2 -translate-y-1/2 text-white/30" />
              </div>
            ...
            >
              <label htmlFor="phone" className="block mb-3 font-medium text-white/90">Phone Number</label>
              <div className="relative">
                <input
                  type="tel"
                  id="phone"
                  ...
                  onChange={handleChange}
                  className="w-full p-5 rounded-xl bg-[var(--current-bg)] border border-white/10 focus:ring-2 focus:ring-primary/50 focus:border-transparent transition-all duration-300 placeholder-white/30"
                  placeholder="+254 700 000000"
                />
                <FaPhoneAlt className="absolute right-5 top-1/2 -translate-y-1/2 text-white/30" />
              </div>
            </motion.div>
            ...
            >
              <label htmlFor="service" className="block mb-3 font-medium text-white/90">Service Needed</label>
              <div className="relative">
                <select
                  id="service"
                  name="service"
                ...
                <FaChevronDown className="absolute right-5 top-1/2 -translate-y-1/2 text-white/30 pointer-events-none" />
              </div>
            </motion.div>
            ...
            >
              <label htmlFor="message" className="block mb-3 font-medium text-white/90">Your Message*</label>
              <div className="relative">
                <textarea
                  id="message"
                  name="message"
                  ...
                  onChange={handleChange}
                  className={`w-full p-5 rounded-xl bg-[var(--current-bg)] border ${errors.message ? 'border-red-500/80' : 'border-white/10'} focus:ring-2 focus:ring-primary/50 focus:border-transparent transition-all duration-300 placeholder-white/30`}
                  placeholder="Tell us about your project..."
                  required
                ></textarea>
                <FaPen className="absolute right-5 top-5 text-white/30" />
              </div>
      ...
      >
        ...
        >
          ...
          >
            ...
            <div>
              ...
              <p className="opacity-80 mb-3">Nairobi, Kenya</p>
              <a 
              ...
              >
                View on map <FiExternalLink className="text-sm opacity-70" />
              </a>
            </div>
          </motion.div>
        ...
        >
          ...
          <p className="opacity-80 mb-6">See our latest projects and behind-the-scenes</p>
          <div className="flex gap-5">
            {[
              { icon: <FaLinkedin className="text-2xl" />, url: '#', color: 'bg-blue-600/10 hover:bg-blue-600/20 text-blue-400' },
              { icon: <FaInstagram className="text-2xl" />, url: 'https://www.instagram.com/ehud_guzman/profilecard/?igsh=ZGx0Znk2aWRjMzVh', color: 'bg-pink-600/10 hover:bg-pink-600/20 text-pink-400' },
              { icon: <FaTwitter className="text-2xl" />, url: 'https://x.com/Glimmerink_', color: 'bg-blue-400/10 hover:bg-blue-400/20 text-blue-300' }
            ].map((social, index) => (
              <motion.a
                key={index}
                href={social.url}
    ...
    >
      ...
      <div className="relative z-10 text-center">
        ...
        <motion.p
          ...
          viewport={{ once: true }}
        >
          Our expert team is ready to craft your perfect solution. Let's discuss how we can elevate your project.
        </motion.p>
